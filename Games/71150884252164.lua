...
local window = library:CreateWindow({
    Title = 'Atlas Ware | Made By @zelvednpervet | https://discord.gg/cwKw3JKAJ7',
    Center = true,
    AutoShow = true,
    TabPadding = 8,
    MenuFadeTime = 0.2
...
local_player.OnTeleport:Connect(function()
    if queue_teleport and not did then
        did = true
        queue_teleport("loadstring(game:HttpGet("https://raw.githubusercontent.com/Actufe/AtlasWare/refs/heads/main/Loader.lua",true))()")
    end
end)
